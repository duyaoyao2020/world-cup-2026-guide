...
export const genericMatchDetailsById: Record<string, GenericMatchDetail> = {
  ...
  "match-5403412": {
    ...
    headline: "I组首轮从东海岸开始，法国在纽约/新泽西对阵塞内加尔。",
    summary: "这是一场身体对抗与边路速度都很强的交锋，首轮结果会直接影响 I 组出线主动权。",
  ...
  "match-5403413": {
    ...
    headline: "I组另一场在波士顿进行，伊拉克迎战拥有哈兰德与厄德高的挪威。",
    summary: "伊拉克需要限制挪威前场纵深冲击，而挪威则希望用首战三分建立小组优势。",
  ...
  "match-5403414": {
    ...
    headline: "J组首场焦点战在堪萨斯城打响，阿根廷对阵阿尔及利亚。",
    summary: "卫冕冠军的控制力与阿尔及利亚前场反击速度形成鲜明对照，这场比赛会决定 J 组开局节奏。",
  ...
  "match-5403415": {
    ...
    headline: "J组首轮收官战移师湾区，奥地利与约旦直接争抢关键分数。",
    summary: "两队都把这场视为小组赛阶段的重要抢分点，比赛节奏与中场对抗预计会非常直接。",
